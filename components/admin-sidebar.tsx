...
import { Flame, LayoutDashboard, Package, Users, Truck, BarChart3, Settings, LogOut, Menu, X } from "lucide-react"
...
export function AdminSidebar() {
  ...
  const menuItems = [
    ...
    { href: "/dashboard/admin/bookings", label: "Bookings", icon: Package },
      ...
      >
        <div className="p-6 border-b border-sidebar-border">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg text-sidebar-foreground">GasFlow Admin</span>
          </div>
        </div>
